...
num_per_file = 1000;
for interval = 1:6
for iter_model = 1+num_per_file*(interval-1):num_per_file+num_per_file*(interval-1)
    ...
    RSU_Veh_dist = zeros(N_Veh, N_Rsu);
    ...
    %Vehicle CPU Performance(Cpu clock)
    ...
    %Cpu frequency
    Rsu_Cpu = (RSU_Cpu_fre_list(interval) + RSU_Cpu_rnd_ext(interval)*rand(1,N_Rsu))*10^9;
    ...
    model_save_path = 'data/fre_change_final_revise/model';
    model_save_path = [model_save_path num2str(iter_model)];
